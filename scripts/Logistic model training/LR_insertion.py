...
def lr_insertion(datadir, fname):
    ...
    # They define validation set size but end up not using it because they dont need to have it defined as it's just
    # the whole set - the training part
    ...
    for i in range(train_size):
        if 1 > sum(y[i,
                   -21:]) > 0:  # 5 is a random number i picked if i use pred_size here it will be -21:0 it will just generate empty array
